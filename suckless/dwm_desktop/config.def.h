...
static const char *fonts[]                = { "JetBrainsMonoNerdFont:size=10:antialias=true:style=SemiBold" };
static const char dmenufont[]             = "JetBrainsMonoNerdFont:size=10:antialias=true:style=SemiBold";
...
static const char *colors[][3]            = {
  /*               fg         bg         border   */
  [SchemeNorm] = { "#C8D0E0", "#3B4252", "#A0A8C4"  },
  [SchemeSel]  = { "#C8D0E0", "#57687d", "#81A1C1"  },
};
