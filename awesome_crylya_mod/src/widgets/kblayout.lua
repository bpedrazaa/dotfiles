...
return function(s)
          ...
          {
            {
              ...
              resize = false,
              image = gears.color.recolor_image(icondir .. "keyboard.svg", color["light0_soft"])
            },
            id = "icon_layout",
        ...
        awful.spawn.easy_async_with_shell(
          ...
          function(stdout)
            ...
            if kb_layout_item.keymap == layout then
              kb_layout_item.bg = color["faded_orange"]
              kb_layout_item:get_children_by_id("background2")[1].fg = color["light0_soft"]
              kb_layout_item:get_children_by_id("background1")[1].fg = color["light0_soft"]
            else
              kb_layout_item.bg = color["dark2"]
              kb_layout_item:get_children_by_id("background2")[1].fg = color["light0_soft"]
              kb_layout_item:get_children_by_id("background1")[1].fg = color["light0_soft"]
            end
          end
  ...
  local kb_menu_widget = awful.popup {
    ...
    fg = color["light0_soft"],
    border_width = dpi(4),
    border_color = color["light0_soft"],
    width = dpi(100),
    max_height = dpi(600),
    visible = false,
    ontop = true,
  ...
  kb_menu_widget:connect_signal(
    ...
    function()
      mousegrabber.run(
        function()
          kblayout_widget.bg = color["dark1"]
          awesome.emit_signal("kblayout::hide:kbmenu")
          mousegrabber.stop()
          return true
        end,
  ...
  -- Signals
  Hover_signal(kblayout_widget, color["dark2"], color["light0"])
