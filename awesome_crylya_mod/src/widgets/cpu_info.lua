...
return function(widget, clock_mode)
  ...
  Hover_signal(cpu_usage_widget, color["dark2"], color["light0"])
  Hover_signal(cpu_clock, color["dark2"], color["light0"])
