...
static const char *fonts[]          = { "JetBrainsMonoNerdFont:size=11:antialias=true:style=SemiBold" };
static const char dmenufont[]       = "JetBrainsMonoNerdFont:size=11:antialias=true:style=SemiBold";
...
static const char col_border[]      = "#e2d3ba";
static const char col_border2[]     = "#d4be98";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_fg,    col_bg,    col_border2},
	[SchemeSel]  = { col_fg,    col_bg2,   col_border},
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_bg, "-nf", col_fg, "-sb", col_border, "-sf", col_fg, NULL };
